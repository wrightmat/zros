...
function behavior:create(enemy, properties)
  ...
  if properties.detection_distance == nil then
    properties.detection_distance = 100
  end
  ...
  function enemy:on_dead()
    ...
    if rand > 7 and properties.treasure_variant > 0 then   -- 30% chance of getting a special treasure.
      self:get_map():create_pickable( { x = x, y = y, layer = l, treasure_name = "monster_wings", treasure_variant = properties.treasure_variant } )
    end
  end
end
