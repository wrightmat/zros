...
function dialog_box:show_dialog()
  ...
  self.importance = dialog.importance or 1
  self.inheritance = dialog.inheritance or 0
  self.var_require = dialog.var_require or nil
  self.var_exclude = dialog.var_exclude or nil
  self.var_boolean = dialog.var_boolean or nil
  self.var_include = dialog.var_include or nil
  self.known = dialog.known or false

  -- Start displaying text.
  self:show_more_lines()
end

function game:get_dialog_property(prop, dialog)
